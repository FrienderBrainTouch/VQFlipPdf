...
function IntroScreen({ onBack = null }) {
  // 화면 크기 상태 관리
  ...
  const sectionImgMapping = {
    ...
    3: ['/interacivefile/VQFile/sectionimg/3-1.png', '/interacivefile/VQFile/sectionimg/3-2.png'],
  ...
  /**
   * 홈 버튼 클릭 핸들러 - IntroScreen 재시작 또는 뒤로 가기
   */
  const handleHomeClick = () => {
    // onBack이 있으면 뒤로 가기, 없으면 IntroScreen 재시작
    if (onBack) {
      onBack();
      return;
    }
                                    ...
                                    <div key={videoIndex} className="relative">
                                      {videoId ? (
                                        <div
                                          ...
                                          style={{ paddingBottom: '56.25%', pointerEvents: 'auto' }}
                                        >
                                          {isLoaded ? (
                                            <iframe
                      ...
                      individualImagePositions[currentPage + 1] && (
                        <>
                          {sectionImgMapping[currentPage + 1].map((mediaSrc, imgIndex) => {
                            ...
                            const imagePosition =
                              individualImagePositions[currentPage + 1]?.[imgIndex];
                            ...
                            return (
                              <div
                                ...
                                style={imagePosition}
                                onClick={(e) => handleSectionImgClick(mediaSrc, e, currentPage + 1)}
                              >
                                {isVideo ? (
                                  <video
                                    src={mediaSrc}
